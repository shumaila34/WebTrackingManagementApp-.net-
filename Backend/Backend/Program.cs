...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    ...
    {
        options.RequireHttpsMetadata = true;  // Make sure to set to true for production
        ...
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            ValidIssuer = builder.Configuration["Jwt:Issuer"], // e.g. "yourapp.com"
            ValidAudience = builder.Configuration["Jwt:Audience"], // e.g. "yourapp.com"
